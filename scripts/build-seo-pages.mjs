...
const topics = [
  ...
  topic({
    slug: "how-to-use-nomad-translator",
    enTitle: "How to Use Nomad Translator",
    enDescription: "A simple setup guide for using Nomad Translator before a trip: download language packs, test text, voice, camera, and photo translation.",
    enFocus: "how to use Nomad Translator",
    enScenario: "setting up the app before travel, testing offline language packs, and learning which input mode to use in real situations",
    enTags: ["how to use Nomad Translator", "Nomad Translator guide", "offline translator setup", "language packs", "camera translator", "Nomad Translator"],
    viTitle: "Cách dùng Nomad Translator trước chuyến đi",
    viDescription: "Hướng dẫn setup Nomad Translator trước khi đi du lịch: tải gói ngôn ngữ, thử dịch text, giọng nói, camera và ảnh.",
    viFocus: "cách dùng Nomad Translator",
    viScenario: "setup app trước chuyến đi, kiểm tra gói ngôn ngữ offline và biết lúc nào nên dùng text, giọng nói, camera hoặc ảnh",
    viTags: ["cáchdùngNomadTranslator", "hướngdẫnNomadTranslator", "setupappdịchoffline", "góingônngữ", "dịchcamera", "NomadTranslator"]
  }),
  topic({
    slug: "best-translation-app-for-offline-travel",
    enTitle: "Best Translation App for Offline Travel",
    enDescription: "What to look for in a translation app for offline travel: language packs, camera translation, voice input, privacy, and quick access.",
    enFocus: "best translation app for offline travel",
    enScenario: "choosing one translator app before flights, international trips, weak signal areas, restaurants, hotels, and transit days",
    enTags: ["best translation app for travel offline", "offline travel translator", "best offline translator app", "travel translator app", "translator without internet", "Nomad Translator"],
    viTitle: "App dịch tốt cho du lịch offline",
    viDescription: "Những gì cần có ở app dịch cho chuyến đi offline: gói ngôn ngữ, dịch camera, nhập giọng nói, riêng tư và mở nhanh.",
    viFocus: "app dịch tốt cho du lịch offline",
    viScenario: "chọn một app dịch trước chuyến bay, chuyến đi nước ngoài, vùng sóng yếu, nhà hàng, khách sạn và ngày di chuyển dài",
    viTags: ["appdịchdulịchoffline", "besttranslationappfortraveloffline", "appdịchofflinetốt", "traveltranslatorapp", "dịchkhôngcầninternet", "NomadTranslator"]
  }),
  topic({
    slug: "bester-offline-ubersetzer-iphone",
    enTitle: "Bester Offline-Übersetzer für iPhone",
    enDescription: "A German-language search guide for choosing an offline translator for iPhone when traveling without reliable internet.",
    enFocus: "bester Offline-Übersetzer iPhone",
    enScenario: "German-speaking travelers comparing iPhone translator apps before trips with weak roaming, train stations, hotels, restaurants, and signs",
    enTags: ["bester Offline-Übersetzer", "offline übersetzer iphone", "offline translator iPhone", "travel translator app", "camera translator", "Nomad Translator"],
    viTitle: "Offline Übersetzer iPhone cho người dùng tiếng Đức",
    viDescription: "Trang dành cho query tiếng Đức khi chọn app dịch offline trên iPhone cho chuyến đi không có internet ổn định.",
    viFocus: "offline übersetzer iPhone cho người dùng tiếng Đức",
    viScenario: "người dùng tiếng Đức so sánh app dịch iPhone trước chuyến đi có roaming yếu, nhà ga, khách sạn, nhà hàng và biển báo",
    viTags: ["offlineübersetzeriPhone", "besterOfflineÜbersetzer", "appdịchofflineiPhone", "Germantraveltranslator", "dịchcamera", "NomadTranslator"]
  }),
  topic({
...
const localizedTopicFocus = {
  ...
  "how-to-use-nomad-translator": { de: "Nomad Translator verwenden", fr: "comment utiliser Nomad Translator", es: "cómo usar Nomad Translator" },
  "best-translation-app-for-offline-travel": { de: "beste Übersetzungs-App für Offline-Reisen", fr: "meilleure app de traduction pour voyager hors ligne", es: "mejor app de traducción para viajar sin conexión" },
  "bester-offline-ubersetzer-iphone": { de: "bester Offline-Übersetzer für iPhone", fr: "meilleur traducteur hors ligne pour iPhone", es: "mejor traductor sin conexión para iPhone" },
